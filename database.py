...
def create_users_table():
    database = sqlite3.connect('food.db')
...
def insert_products_table():
    ...
    (1, 'Lavash detskiy', 25000, 'Ichi to`la o`tga va gazo`nli lavash', 'media/lavash/fitter_lavash.jpg'),
    (1, 'Lavash achchiq', 27000, 'Mol goshtli achchiq pamidor, bodring', 'media/lavash/mol_achchiq_lavash.jpg'),
    (1, 'Lavash sirli', 29000, 'Mol goshtli sirli pamidor, bodring', 'media/lavash/mol_sirli_lavash.jpg'),
    (1, 'Lavash tovuq achchiq', 28000, 'Tovuq achchiq goshtli', 'media/lavash/tovuq_achchiq_lavash.jpg'),
    (1, 'Lavash tovuq sir', 28000, 'Tovuq sirli pamidor bodring', 'media/lavash/tovuq_sirli_lavash.jpg'),
    (1, 'Lavash tovuq', 29000, 'Tovuq goshtli pamidor bodring', 'media/lavash/tovuq_lavash.jpg')
...
# user_id olganligini tekshirish !
...
def get_total_products_price(cart_id):
    ...
    ''', (cart_id,))
    total_products, total_price = cursor.fetchone()  # (4, 108.000)
    database.close()
